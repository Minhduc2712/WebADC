...
namespace ErpOnlineOrder.WebMVC.Services
{
    public interface ICustomerApiClient
    {
        ...
        Task<PagedResult<CustomerDTO>> GetPagedAsync(int page = 1, int pageSize = 20, string? searchTerm = null, int? regionId = null, int? customerCategoryId = null, CancellationToken cancellationToken = default);
